...
# Hard-coded experiment layout for a simplify-preprocessed v4 run.
# This keeps the explicit v3 structure, but changes the detector training
...
DETECTOR_WORKDIR="$V4_ROOT/train_detector_deimv2_m"
SAM2_WORKDIR="$V4_ROOT/train_segmenter_sam2_1_hiera_base_plus"

BOX_VALI_DPATH="$V4_ROOT/eval_detector_only/vali"
BOX_TEST_DPATH="$V4_ROOT/eval_detector_only/test"

GTBOX_TUNED_RAW_VALI_DPATH="$V4_ROOT/eval_gtbox_segmenter/vali/tuned_raw"
GTBOX_ZEROSHOT_RAW_VALI_DPATH="$V4_ROOT/eval_gtbox_segmenter/vali/zeroshot_raw"

COMBINED_TUNED_RAW_VALI_DPATH="$V4_ROOT/eval_detector_segmenter/vali/tuned_raw"
COMBINED_TUNED_RAW_TEST_DPATH="$V4_ROOT/eval_detector_segmenter/test/tuned_raw"

PACKAGE_DPATH="$REPO_DPATH/experiments/foundation_detseg_v3/packages"
TUNED_PACKAGE_FPATH="$PACKAGE_DPATH/v4_deimv2_m_sam2_1_hiera_base_plus_tuned.yaml"
ZEROSHOT_PACKAGE_FPATH="$PACKAGE_DPATH/v4_deimv2_m_sam2_1_hiera_base_plus_zeroshot.yaml"
...
export ENABLE_SIMPLIFY_PREPROCESS="True"
export FORCE_SIMPLIFY_PREPROCESS="False"
export SIMPLIFY_MINIMUM_INSTANCES="100"
...
if [ -f "$ZEROSHOT_PACKAGE_FPATH" ]; then
    ...
    python -m shitspotter.algo_foundation_v3.cli_package build \
        ...
        --metadata_name v4_deimv2_m_sam2_1_hiera_base_plus_zeroshot
fi
