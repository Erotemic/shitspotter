...
\begin{figure*}[h]
\centering
\includegraphics[width=1.0\textwidth]{/data/joncrall/dvc-repos/shitspotter_expt_dvc/_shitspotter_test_evals/eval/flat/heatmap_eval/heatmap_eval_id_37a99689/test_result_heatmaps.jpg}
\caption[]{
...
\centering
\includegraphics[width=1.0\textwidth]{/home/joncrall/data/dvc-repos/shitspotter_expt_dvc/_shitspotter_evals/eval/flat/heatmap_eval/heatmap_eval_id_6b952f74/vali_result_heatmaps.jpg}
\caption[]{
...
Qualitative results for the test set are shown in \cref{fig:test_results} and the validation set in \cref{fig:vali_results}.
