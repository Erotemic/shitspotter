...
Measuring resource usage directly at train time is still in development, but we
estimate the time of each training run using indirect measurements: timestamps
on checkpoint and log files. We estimate that each of the 7 training runs took
about 5 days and 15 hours, totaling about 49.2 GPU days. Using the maximum 350W
power draw of a 3090 GPU, we estimate energy usage of 17.2 kilowatt hours,
assuming a 0.21 conversion ratio is 3.6 kilograms of CO2.
