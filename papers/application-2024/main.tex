...
Image W \times H is the pixel width and height of the image with the median area. Annot Area$^{0.5}$ is the median sqrt(area) in pixels of the annotation polygon or box. The Size column refers to the size of the dataset in gigabytes.
...
\begin{comment}
    ...
    /home/joncrall/code/shitspotter/papers/application-2024
