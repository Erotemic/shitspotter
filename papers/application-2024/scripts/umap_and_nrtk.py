...
def main():
    ...
    Ignore:
        import sys, ubelt
        sys.path.append(ubelt.expandpath('~/code/shitspotter/papers/application-2024/scripts'))
...
def play_with_descriptors():
    ...
    fpath = ub.Path('~/code/shitspotter/papers/application-2024/figures/umap-v3.jpg').expand()
...
if __name__ == '__main__':
    """
    CommandLine:
        python ~/code/shitspotter/papers/application-2024/scripts/umap_and_nrtk.py
