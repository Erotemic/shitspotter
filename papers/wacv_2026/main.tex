...
\footnotetext{\redact{Accepted to the \emph{International Workshop on Smart Waste Monitoring (WasteVision)} at WACV 2026.}}%
...
% Keywords: computer vision dataset, object detection, segmentation, small object detection, feces detection, dog feces, hard negatives, background clutter, environmental monitoring, dataset distribution, content addressing, IPFS
