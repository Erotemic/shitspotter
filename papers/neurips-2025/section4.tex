...
The number of parameters for MaskRCNN, VIT, GroundingDINO, and YOLO are
43.9M, 25.5M, 172.2M, and 51.0M, respectively.
Hyperparameters are given in the supplemental material (\Cref{sec:model_hyperparams}).
