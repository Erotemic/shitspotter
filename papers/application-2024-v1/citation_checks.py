...
def main():
    ...
    document_fpath = ub.Path('~/code/shitspotter/papers/application-2024/main.tex').expanduser()
    ...
    pdf_fpath = ub.Path('~/code/shitspotter/papers/application-2024/citation_checks.pdf').expand()
...
if __name__ == '__main__':
    """
    CommandLine:
        python ~/code/shitspotter/papers/application-2024/citation_checks.py
    """
    main()
