...
class GroundingDinoPrediction(ProcessNode):
    """
    Runs GroundingDino prediction for a prompt.
    """
    name = 'grounding_dino_pred'
    group_dname = PREDICT_NAME
    executable = 'python -m shitspotter.other.predict_grounding_dino'
...
def grounding_dino_evaluation_pipeline():
    ...
    gpred = nodes['grounding_dino_pred'] = GroundingDinoPrediction()
